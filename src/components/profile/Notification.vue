<template>
  <div class="notification" v-click-outside="onClickOutside" >
    <button
      :class="['notification__btn', { 'notification__btn--active' : isShow }, { 'notification__btn--has-new' : !!getNewNotifications }]"
      @click="toggleNotification"
      v-ripple
    >
      <svg class="notification__icon" xmlns="http://www.w3.org/2000/svg" width="15" height="16" viewBox="0 0 15 16" fill="none">
        ...
        <div class="notification__content" ref="content">
          <ul class="notification__list">
            <router-link
              ...
              exact
            >
              <div @click="toggleNotification" class="notification__inner">
                <div class="notification__status">
                  <div
                    :class="[
                      'notification__badge',
                      { 'notification__badge--new' : !parseInt(notification.notification_is_read) }
                      ]">
                    <svg
                      v-if="!parseInt(notification.notification_is_read)"
                      viewBox="-37 -19 618 618.66669" width="618pt" xmlns="http://www.w3.org/2000/svg"><path d="m413.261719 555h-329.207031c-31.769532 0-57.472657-24.65625-57.472657-54.984375v-453.734375c-15 4.125-27.5 17.667969-27.5 33.703125v465.070313c0 19.300781 16.757813 34.945312 37.5 34.945312h340.640625c17.011719 0 31.417969-10 36.039063-25zm0 0"/><path d="m462.832031 500.015625v-247.515625h-282.640625l-.140625 15.472656c0 .148438.007813-.472656.035157.777344h120.300781c5.523437 0 10 4.476562 10 10s-4.476563 10-10 10h-121.421875c-4.914063-.148438-9.574219-2.246094-12.941406-5.828125-3.917969-4.171875-6.054688-9.699219-5.972657-15.417969l.136719-15h-21.125c-2.625.050782-5.164062-.957031-7.042969-2.796875-1.875-1.839843-2.9375-4.359375-2.9375-6.988281v-1.46875h-30.0625c-5.492187.003906-9.960937-4.421875-10-9.917969l-.316406-43.523437c-.019531-5.582032 4.421875-10.160156 10-10.308594h.09375l30.285156.589844v-1.277344c0-5.523438 4.453125-10.5625 9.976563-10.5625h323.773437v-45h-84.660156c-8.722656.058594-17.105469-3.378906-23.273437-9.546875-6.171876-6.160156-9.613282-14.539063-9.566407-23.261719v-88.441406h-261.277343c-20.273438 0-36.9375 14.980469-37.671876 33.6875.117188.421875.207032.859375.265626 1.292969 0 .527343-.066407 1.042969-.066407 1.550781v463.484375c0 19.300781 16.734375 34.984375 37.472657 34.984375h340.640624c20.730469 0 38.136719-15.683594 38.136719-34.984375zm-363.703125-185.015625h164.414063c5.519531 0 10 4.476562 10 10s-4.480469 10-10 10h-164.414063c-5.523437 0-10-4.476562-10-10s4.476563-10 10-10zm286.140625 166.25h-286.140625c-5.523437 0-10-4.476562-10-10s4.476563-10 10-10h286.140625c5.523438 0 10 4.476562 10 10s-4.476562 10-10 10zm0-48.75h-286.140625c-5.523437 0-10-4.476562-10-10s4.476563-10 10-10h286.140625c5.523438 0 10 4.476562 10 10s-4.476562 10-10 10zm0-48.75h-286.140625c-5.523437 0-10-4.476562-10-10s4.476563-10 10-10h286.140625c5.523438 0 10 4.476562 10 10s-4.476562 10-10 10zm0 0"/><path d="m447.726562 101.25-82.394531-85.230469v72.421875c-.050781 3.417969 1.28125 6.714844 3.703125 9.128906 2.417969 2.414063 5.71875 3.742188 9.136719 3.679688zm0 0"/><path d="m520.332031 195.25v29.03125l22.3125-14.515625zm0 0"/><path d="m149.082031 186.25h351.25v46.25h-351.25zm0 0"/><path d="m129.082031 221.25v-23.160156l-20.292969-.234375.15625 23.394531zm0 0"/></svg>
                    <svg
                      v-else
                ...
                <div class="notification__info">
                  ...
                  <h6 class="notification__title" v-text="notification.title" />
                  <p class="notification__desc" v-text="notification.text" />
                </div>
              </div>
            </router-link>
          </ul>
        </div>
        <div class="notification__footer" v-ripple="'rgba(255,255,255,0.3)'" @click="toggleNotification">
          <router-link
            :to="'/reports'"
            exact
...
<script>
  ...
  export default {
    ...
    async created() {
      await this.NOTIFICATIONS_REQUEST();
    },
    computed: {
      ...mapGetters(['getTotalNotifications', 'getNotifications', 'isNotifications', 'getNewNotifications']),
      isShow: function() {
...
@keyframes ringbell {
  ...
  75% {
    transfrom: rotate(-18deg) scale(1)
  }
  100% {
...
.notification {
  ...
  &__content {
    ...
    &::-webkit-scrollbar-thumb {
      border: 3px solid rgba(14, 214, 220, 0.5);
    }
